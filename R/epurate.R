...
# Features of the Epurate Template
epurate_site <- function(toc = TRUE, toc_depth = 2, code_folding = "hide", number_sections=TRUE) {

  # get the locations of resource files located within the package
  css <- system.file("rmarkdown", "templates", "epurate_site" ,"resources", "style.css", package = "epuRate")
  template <- system.file("rmarkdown", "templates", "epurate_site" ,"resources", "template_epurate.html", package = "epuRate")
...
QIMR <- function(toc = TRUE, toc_depth = 2, code_folding = "hide", number_sections=TRUE) {
