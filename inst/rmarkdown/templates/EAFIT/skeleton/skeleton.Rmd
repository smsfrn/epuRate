...
library(icons)         # Inset icons from many sources in markdown remotes::install_github("mitchelloharawild/icon") download_fontawesome() is one of the greatest icon library
```
